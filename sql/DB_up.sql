...
CREATE TABLE IF NOT EXISTS Brand(bid integer AUTO_INCREMENT NOT NULL,
...
CREATE TABLE IF NOT EXISTS Brand_Model (bmid integer AUTO_INCREMENT NOT NULL,
...
CREATE TABLE IF NOT EXISTS Cart  (brand_model_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS Brand_model_image (brand_model_image_id INTEGER AUTO_INCREMENT NOT NULL,
...
CREATE TABLE IF NOT EXISTS Checkout (checkout_id INTEGER AUTO_INCREMENT NOT NULL,
